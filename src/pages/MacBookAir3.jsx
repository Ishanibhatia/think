...
const MacBookAir3 = () => {
  ...
  return (
    <div className="w-full h-screen relative bg-gray-100 overflow-hidden flex flex-col items-start justify-start gap-[0.125rem] leading-[normal] tracking-[normal] ">
      <FrameComponent3 />
